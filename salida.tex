...
\title{2537100: Vivamos la Universidad}
\author{\begin{tabular} {c|c|c|c|c|c} Teórico & \textbf{2} & Teórico-Práctico & \textbf{0} & Práctico & \textbf{0}\end{tabular}
\\
...
\noindent \begin{tabular}{R{0.5\textwidth} C{0.2\textwidth} C{0.2\textwidth}}
	...
	\midrule
	actividad evaluacion 1 & 20 & 2019-10-29 \\ actividad evaluacion 2 & 30 & 2019-10-30 \\ xavier & 100 & 2019-12-31 \\ 
	\midrule
\end{tabular}
\\
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
