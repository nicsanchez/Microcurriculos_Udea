...
%DIF DEL /home/nicolas/CursoDjango/Microcurriculos/Microcurriculos_Udea/salida.tex    Sat Apr  4 04:02:54 2020
%DIF ADD /home/nicolas/CursoDjango/Microcurriculos/Microcurriculos_Udea/salida2.tex   Sat Apr  4 04:02:57 2020
...
\begin{itemize}
\item especifico 1 \item especifico 2 \DIFaddbegin \item \DIFadd{especifico 3 
...
\end{tabular} 
 \\ 
 \DIFaddbegin \begin{tabular}{R{0.16\textwidth} L{0.7\textwidth}} 
 \\ 
\toprule \textbf{\DIFadd{Unidad No. 3}} & \DIFadd{temas unidad 3 
 }\\ 
\midrule\textbf{\DIFadd{Subtemas}} & 
\begin{description}
 \item \DIFadd{subtema 1 unidad 3 
}\end{description}
 \\ 
\textbf{\DIFadd{Semanas}} & \DIFadd{10 
}\end{tabular} 
 \\ 
 \DIFaddend 
...
\noindent \begin{tabular}{R{0.5\textwidth} C{0.2\textwidth} C{0.2\textwidth}}
	...
	\\
	\midrule
	actividad evaluacion 3 & 23 & 2020-04-30 \\ 
	\DIFdelbegin \DIFdel{actividad evaluacion 2 }%DIFDELCMD < & %%%
\DIFdel{12 }%DIFDELCMD < & %%%
\DIFdel{2020-04-27 }%DIFDELCMD < \\ 
%DIFDELCMD < 	%%%
\DIFdelend \\
	\midrule
\end{tabular}
