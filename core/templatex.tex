...
\title{codicur: nomcur}
\author{\begin{tabular} {c|c|c|c|c|c} Teórico & \textbf{hoteo} & Teórico-Práctico & \textbf{hotepr} & Práctico & \textbf{hoprac}\end{tabular}
\\
\begin{tabular} {c|c|c|c|c|c} Validable & \textbf{valcur} & Habilitable & \textbf{habcur} & Clasificable & \textbf{clascur}\end{tabular}}
\date{vigencur}
...
\textbf{Semestre:} semcur & \textbf{Semanas:} semncur
\\
\textbf{Área:} areacur &    \textbf{Créditos:} credicur 
\\ & \\
\textbf{Programas a los cuales se ofrece:} progrcur
\\ & \\
\hline
\end{tabular*}
...
\begin{description}
\item [Prerrequisitos:] precur
\item[Correquisitos:] corrcur
\end{description}
