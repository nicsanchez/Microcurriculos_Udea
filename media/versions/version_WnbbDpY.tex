...
\begin{itemize}
\item general 1 ingles \item general 2 ingles \item general 3 ingles 
\end{itemize}

\subsection*{Específicos}

\begin{itemize}
\item Especifico 1 ingles 
\end{itemize}
...
\begin{itemize}
\item item 1 ingles \item item 2 ingles \item item 3  ingles 
\end{itemize}
...
\begin{tabular}{R{0.16\textwidth} L{0.7\textwidth}} 
 \\ 
\toprule \textbf{Unidad No. 1} & Tema unidad 1 ingles 
 \\ 
\midrule\textbf{Subtemas} & 
\begin{description}
 \item subtema 1 unidad 1 ingles \item subtema 2 unidad 1 ingles 
\end{description}
 \\ 
\textbf{Semanas} & 5 
\end{tabular} 
 ...
 \begin{tabular}{R{0.16\textwidth} L{0.7\textwidth}} 
 \\ 
\toprule \textbf{Unidad No. 2} & Tema unidad 2 ingles 
 \\ 
\midrule\textbf{Subtemas} & 
\begin{description}
 \item subtema 1 unidad 2 ingles \item subtema 2 unidad 2 ingles 
\end{description}
 \\ 
\textbf{Semanas} & 4 
\end{tabular} 
...
\noindent \begin{tabular}{R{0.5\textwidth} C{0.2\textwidth} C{0.2\textwidth}}
	...
	\\
	\midrule
	actividad evaluacion 1 ingles & 10 & 2020-03-28 \\ actividad evaluacion 2 ingles & 90 & 2020-03-28 \\ 
	\\
	\midrule
\end{tabular}
\\
...
\begin{itemize}
\item basica 1 ingles \item Basica 2 ingles 
\end{itemize}

\subsection*{Complementaria}

\begin{itemize}
\item complemen 1 ingles \item complemen 2 ingles 
\end{itemize}
